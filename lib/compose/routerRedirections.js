...
exports.createRouterRedirectFuncs = createRouterRedirectFuncs;
...
function getRedirectUrl(pathname) {
    var prevLocation = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
 ...
 */
function createRouterRedirectFuncs(isLoggedInFromState, loginPagePath, rootPath) {
    /**
    ...
    function redirectionCheck(getState, nextRouterState, redirect) {
        var routes = nextRouterState.routes,
            location = nextRouterState.location;
        ...
        var userLoggedIn = isLoggedInFromState(getState());
    ...
    return {
        getOnEnterFunc: getOnEnterFunc,
        getOnChangeFunc: getOnChangeFunc
    };
}
//# sourceMappingURL=routerRedirections.js.map